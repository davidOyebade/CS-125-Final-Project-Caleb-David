...
TRUNCATE TABLE EventType; -- <--- ADDED
...
-- 11) INSERT EventType (5 common types) -- implicit IDs (1..5)
INSERT INTO EventType (Name) VALUES
('Weekly Youth Night'),       -- ID 1
('Off-Site Retreat'),         -- ID 2
('Service Project'),          -- ID 3
('Program Training/Meeting'), -- ID 4
('Social/Party');             -- ID 5


-- 12) INSERT Event (10 events)
-- PlaceID references the Place table created above (1..5)
-- EventTypeID references the EventType table created above (1..5)
INSERT INTO Event (Name, EventTypeID, PlaceID, StartDateTime, EndDateTime) VALUES
('Weekly Youth Night - Jan',     1, 2, '2025-01-12 18:30:00', '2025-01-12 21:00:00'), -- Type 1
('Weekly Youth Night - Feb',     1, 2, '2025-02-09 18:30:00', '2025-02-09 21:00:00'), -- Type 1
('Spring Retreat',               2, 4, '2025-03-21 09:00:00', '2025-03-23 15:00:00'), -- Type 2
('Service Project',              3, 5, '2025-04-05 08:00:00', '2025-04-05 17:00:00'), -- Type 3
('Summer Kickoff',               5, 1, '2025-06-07 16:00:00', '2025-06-07 22:00:00'), -- Type 5
('Back-to-School Bash',          5, 3, '2025-08-20 17:00:00', '2025-08-20 20:00:00'), -- Type 5
('Christmas Party',              5, 2, '2025-12-14 18:00:00', '2025-12-14 21:00:00'), -- Type 5
('Volunteer Training',           4, 1, '2025-05-10 09:00:00', '2025-05-10 12:00:00'), -- Type 4
('Parent Info Night',            4, 1, '2025-09-15 19:00:00', '2025-09-15 20:30:00'), -- Type 4
('Outreach Booth',               3, 4, '2025-07-04 10:00:00', '2025-07-04 14:00:00'); -- Type 3
